...
//
//protocol PlusCellsDelegate: class {
//    func TodayCollectionChange()
//}
//class PlusCellsViewController : UIViewController, UIAnimatable{
//    
//    weak var delegate : PlusCellsDelegate?
...
//    }()
//    
//    var FirstTextField = CustomTextField(placeholder: "제목")
//    private lazy var FirstContainerView: InputContainerView = {//lazy
//        return InputContainerView(image: UIImage(systemName: "envelope")
//                                               , textField: FirstTextField)
//    }()
//    
//    var SecondTextField = CustomTextField(placeholder: "내용")
...
//}
//
//extension PlusCellsViewController {
...
//            self.view.frame.origin.y -= 200 //88픽셀 올려라.화면이 올라가서 텍스트 가 좀 보이도록.
//        }
//    }
//    
...
//            print("사진있다.")
//            
//            let resultPurpose = TodayManager.shared.createIndexAndData(image: image, todos: <#T##[Todo]#>)
//            
...
//}
//
//extension PlusCellsViewController : UIImagePickerControllerDelegate & UINavigationControllerDelegate {
//    
